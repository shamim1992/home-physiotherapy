                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-1">
                        {cartItems.length === 0 ? (
                            ...
                            <div key={item.id} className="mt-2 w-full flex flex-col sm:flex-row justify-between gap-4 items-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <a href="#">
                                    <img className="rounded-md hidden md:block shadow-md h-28 w-28" src={item.imageSrc} alt="product image" />
                                </a>
                    ...
                    <div className="sm:col-span-1">
                        <div className="mt-2 w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
