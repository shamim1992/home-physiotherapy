        ...
        <div className='flex'>
            ...
            <div className="flex justify-center flex-grow overflow-x-auto">
                ...
                <div className="px-4 p-4 overflow-x-auto">
                    <h2 className='text-center font-bold py-2 text-2xl'>Cancelled Appointment</h2>
                                ...
                                return (
                                    <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-xs" >
                                        ...
                                        <td className="px-6 py-2 flex items-center">
                                            <button onClick={() => handleViewAppointment(item._id)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 mr-1 rounded btn-xs">
                                                <FaEye />
                                            </button>
                                            <button onClick={() => handleUpdateStatus(item._id, 'confirmed')} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-2 mr-1 rounded btn-xs">
                                                <FaCheckCircle />
                                            </button>
                                            <button onClick={() => handleUpdateStatus(item._id, 'Rejected')} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-2 mr-1 rounded btn-xs">
                                                <FaTrashAlt />
                                            </button>
                                        </td>
                                    </tr>
